object LearningScala4 {
  ...
  // Less flexible
  val captainStuff = ("Picard", "Enterprise-D", "NCC-1701-D", "Captian2")
  ...
  val distinctValues = lotsOfDuplicates.distinct //> distinctValues  : List[Int] =
  ...
  val one_to_twenty = List.range(1, 21)
  ...
  one_to_twenty.filter(_ % 3 == 0).map(println(_))
